...
const NewEmployeeModal = ({ setShowNewEmployeeModal, handleAddNewEmployee }) => {
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log("adding new employ?")
        handleAddNewEmployee(Object.fromEntries(new FormData(e.target)));
    };
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-lg">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button onClick={() => setShowNewEmployeeModal(false)} className="text-gray-500 hover:text-gray-800">
                        <X size={24} />
                    </button>
                </div>
                <form onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input name="jobTitle" required className="w-full p-2 border rounded-lg"/>
                        </div>
                        <div>
                    ...
                    <div className="mt-6 flex justify-end gap-4">
                        <button type="button" onClick={() => setShowNewEmployeeModal(false)} className="px-4 py-2 bg-gray-200 rounded-lg">إلغاء</button>
